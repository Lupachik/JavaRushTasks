...
public class Solution {
    ...
    public static void printStocks(List<Stock> stocks, Date actualDate) {
        ...
        Format[] testFormats = {null, null, null, null, null, dateFormat, fileform};
        // "The order of formats in newFormats corresponds to the order of format elements in the pattern string."
        ...
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (result!=0) return result;
                    ...
                    int dr = date2.compareTo(date1);
                    if(dr!=0)return dr;
                    else {
                        Double change1 = (stock1.get("change")!=null ? (Double)stock1.get("change"): ((Double)stock1.get("last") - (Double)stock1.get("open")));
                        Double change2 = (stock2.get("change")!=null ? (Double)stock2.get("change"): ((Double)stock2.get("last") - (Double)stock2.get("open")));
