...
public class Util {
    ...
    public static List<Jeans> getAllJeans() {
        ...
        class Levis extends AbstractJeans{
            ...
            @Override
            public String toString() {
                return String.format("Levis{id=%d, length=%d, size=%d, price=%.1f}",getId(),getLength(),getSize(),getPrice());
            }
        }
        class Denim extends AbstractJeans{
            ...
            @Override
            public String toString() {
                return String.format("Denim{id=%d, length=%d, size=%d, price=%.1f}",getId(),getLength(),getSize(),getPrice());
            }
        }
